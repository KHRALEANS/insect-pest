...
train_dataset = dict(
    ...
    dataset=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'annotations_v2/train_labels.json',
        img_prefix=data_root + 'train_v2/',
        pipeline=[
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'annotations_v2/val_labels.json',
        img_prefix=data_root + 'val_v2/',
